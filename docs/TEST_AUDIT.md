...
- Acoes de mitigacao para alguns eventos ainda sao agregadas no processamento de sprint. Exemplo: pedido de aumento pode ser resolvido por evolucao/reconhecimento via Kaizen, mas nao ha um comando HTTP dedicado chamado `accept-raise`.
